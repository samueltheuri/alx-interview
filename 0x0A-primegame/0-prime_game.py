...
def isWinner(x, nums):
    ...
    nums (list of int): A list of integers where each integer n denotes a set of consecutive integers starting from 1 up to and including n.
    ...
    for i in range(2, len(a)):
        ...
        for i in nums:
            ...
            def rm_multiples(Is, x):
                """
                Removes multiples of a prime number from an array of possible prime numbers.
                ...
                None.
                """
                #This loop iterates over multioles of a prime number and marks them as
